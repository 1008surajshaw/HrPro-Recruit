...
export const JobLanding = () => {
  return (
    <div id="recent-jobs" className="w-full h-fit md:px-16 px-5 flex flex-col items-center pt-6 md:pt-20 dark:bg-grad-dark bg-grad-light" >
      <div className="w-full h-fit flex flex-col items-center">
        <h2 className="text-center text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Recently Added <span className="text-red-600 dark:text-red-500">jobs</span></h2>
