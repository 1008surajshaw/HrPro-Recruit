...
import { deleteCertificate, deleteEducation } from '@/actions/user.profile.actions';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
const CertificateDeleteDialog = ({
    ...
    const handleContinueClick = async () => {
      try {
        ...
        toast({
          title: 'Something went wrong while deleting the Certificate',
    ...
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This action cannot be undone. This will delete your Certificate.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
