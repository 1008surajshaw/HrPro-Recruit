...
export const SHEETS: Sheets = {
  ...
  certificate:{
    ...
    description:'Share your certificate to highlight your skills and knowledge  '
  },
  companyInfo:{
     title:'Add Company Information',
     description:"Before you post a job complete the company Information"
  },
