...
export const JobPostSchema = z
  .object({
    ...
    responsibilities: z.array(z.string()).optional(), // Expecting responsibilities to be an array of strings
    customQuestions: z.array(
      z.object({
        question: z.string().min(1, "Question is required"),
        idealAns: z.string().optional(),
      })
    ).optional(), // array of objects with required question and optional idealAns
  rejectionMessage: z.string().optional(), // Optional string for rejectionMessage
...
// export type JobPostWithCompanyId = JobPostSchemaType & companyId: z.string().min(1, 'Company ID is required') ;
